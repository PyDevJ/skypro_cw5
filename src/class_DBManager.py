...
class DBManager:
    ...
    def create_database(self):
        """
        Метод удаления старой и создания новой базы данных
        """
    ...
    def create_table_companies(self):
        """
        Метод создания таблицы компаний
        """
        conn = psycopg2.connect(**self.params)
        cur = conn.cursor()
    ...
    def insert_data_company(self, data: dict):
        """
        Метод загрузки данных в таблицу компаний
        """
        conn = psycopg2.connect(**self.params)
        cur = conn.cursor()
    ...
    def insert_data_vacancy(self, vacancies: list):
        """
        Метод загрузки данных в таблицу вакансий
        """
        conn = psycopg2.connect(**self.params)
        cur = conn.cursor()
    ...
    def get_companies_and_vacancies_count(self):
        """
        Метод получения компаний с количеством вакансий
        """
        conn = psycopg2.connect(**self.params)
        cur = conn.cursor()
    ...
    def get_vacancies_with_higher_salary(self):
        """
        Метод получения вакансий с зарплатой выше средней зарплаты по вакансиям.
        """
        conn = psycopg2.connect(**self.params)
        cur = conn.cursor()
        cur.execute('''SELECT company_name, vacancy_name, salary_average, url
